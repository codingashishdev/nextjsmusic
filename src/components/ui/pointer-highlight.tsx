...
export function PointerHighlight({
  ...
  const cotainerRefCurrent = containerRef.current

  useEffect(() => {
    if (cotainerRefCurrent) {
      const { width, height } = cotainerRefCurrent.getBoundingClientRect();
    ...
    if (cotainerRefCurrent) {
      resizeObserver.observe(cotainerRefCurrent);
    }
